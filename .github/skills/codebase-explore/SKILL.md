...
description: Helps explore and understand an unfamiliar area of the codebase. Use when the user asks to explore, investigate, or understand how a feature or module works.
---
